 ...
 * @author cash
 */
public class Register_SportOfficer extends javax.swing.JFrame {

    /**
     * Creates new form login_SportOfficer
     */
    public Register_SportOfficer() {
        initComponents();
    }
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
        ...
        else if(!(Pattern.matches("^[a-zA-Z0-9]+[@]{1}+[a-zA-Z0-9]+[.]{1}+[a-zA-Z0-9]+$", jTextField_email.getText())))
        {
            ...
            String query ="INSERT INTO `sportofficer`(`name`, `surname`, `cellphone`, `email`, `username`, `password`) VALUES (?,?,?,?,?,?)";
    ...
    private void jLabelLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelLoginMouseClicked
        login_sportOffice lg =  new   login_sportOffice ();
        lg.setVisible(true);
        lg.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Register_SportOfficer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Register_SportOfficer().setVisible(true);
            }
        });
    }
