 ...
 * @author cash
 */
public class karate_tournament extends javax.swing.JFrame {

    /**
     * Creates new form karate_tournament
     */
    public karate_tournament() {
        initComponents();
                    //showuser();
...
user = new  company (rs.getInt("id"),rs.getString("company_name"),rs.getString("postal_address"),rs.getString("physical_address"),rs.getString("email"),rs.getString("phone"));
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Karate tournament");
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                ...
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jTextField_email, javax.swing.GroupLayout.DEFAULT_SIZE, 222, Short.MAX_VALUE)
...
/*
        ...
        if(nm.equals("")){
            ...
            String query = "UPDATE `company` SET `company_name`='"+jTextField_company.getText()+"',`postal_address`='"+jTextField_postal.getText()+"',`email`='"+jTextField_email.getText()+"';                                                                                                                                                                                                                                                                                                                     WHERE `id` ="+jTextField_ID.getText()+"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(karate_tournament.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new karate_tournament().setVisible(true);
            }
        });
    }
