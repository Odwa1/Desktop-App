 ...
 * @author cash
 */
public class Basketball_tournament extends javax.swing.JFrame {

    /**
     * Creates new form Basketball_tournament
     */
    public Basketball_tournament() {
        initComponents();
                 //showuser();
...
*/
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Basketball tournament");
        ...
        jLabel31.setText("Winning percentage:");
    ...
    private void jButton_Register_1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_Register_1MouseClicked
     ...
     /*   String nm = jTextField_company.getText();
        ...
        if(nm.equals("")){
            ...
            String query = "UPDATE `company` SET `company_name`='"+jTextField_company.getText()+"',`postal_address`='"+jTextField_postal.getText()+"',`physical_address`='"+jTextField_physical.getText()+"',`email`='"+jTextField_email.getText()+"';                                                                                                                                                                                                                                                                                                                     WHERE `id` ="+jTextField_ID.getText()+"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Basketball_tournament.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Basketball_tournament().setVisible(true);
            }
        });
    }
