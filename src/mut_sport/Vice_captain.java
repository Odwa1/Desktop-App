 ...
 * @author cash
 */
public class Vice_captain extends javax.swing.JFrame {

    /**
     * Creates new form Vice_captain
     */
    public Vice_captain() {
        initComponents();
                 //showuser();
...
user = new  company (rs.getInt("id"),rs.getString("company_name"),rs.getString("postal_address"),rs.getString("physical_address"),rs.getString("email"),rs.getString("phone"));
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Assign Vice-captain");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vice_captain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vice_captain().setVisible(true);
            }
        });
    }
