 ...
 * @author cash
 */
public class Assign_captain extends javax.swing.JFrame {

    /**
     * Creates new form Assign_captain
     */
    public Assign_captain() {
        initComponents();
                    //showuser();
...
user = new  company (rs.getInt("id"),rs.getString("company_name"),rs.getString("postal_address"),rs.getString("physical_address"),rs.getString("email"),rs.getString("phone"));
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Assign captain");
        ...
        jTable12.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Surname", "Students number", "Cellphone number"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Assign_captain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Assign_captain().setVisible(true);
            }
        });
    }
