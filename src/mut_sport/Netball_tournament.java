 ...
 * @author cash
 */
public class Netball_tournament extends javax.swing.JFrame {

    /**
     * Creates new form Netball_tournament
     */
    public Netball_tournament() {
        initComponents();
        //showuser();
...
*/
    ...
    /*    String PhoneNumber = jTextField_phone.getText();
        ...
        if(nm.equals("")){
            ...
            String query = "UPDATE `company` SET `company_name`='"+jTextField_company.getText()+"',`postal_address`='"+jTextField_postal.getText()+"',`email`='"+jTextField_email.getText()+"',`phone`='"+jTextField_phone.getText()+"'                                                                                                                                                                                                                                                                                                                      WHERE `id` ="+jTextField_ID.getText()+"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Netball_tournament.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Netball_tournament().setVisible(true);
            }
        });
    }
