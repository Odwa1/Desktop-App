 ...
 * @author cash
 */
public class sport_codes extends javax.swing.JFrame {

    /**
     * Creates new form sport_codes
     */
    public sport_codes() {
        initComponents();
    }
    ...
    private void jButton_Register_1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_Register_1MouseClicked
        ...
        Dashboard_admin lg =  new Dashboard_admin ();
        lg.setVisible(true);
        lg.pack();
        lg.setLocationRelativeTo(null);
        lg.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sport_codes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sport_codes().setVisible(true);
            }
        });
    }
