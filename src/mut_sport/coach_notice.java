 ...
 * @author cash
 */
public class coach_notice extends javax.swing.JFrame {

    /**
     * Creates new form coach_notice
     */
    public coach_notice() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(coach_notice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new coach_notice().setVisible(true);
            }
        });
    }
