 ...
 * @author cash
 */
public class login_Coach extends javax.swing.JFrame {

    /**
     * Creates new form login_Coach
     */
    public login_Coach() {
        initComponents();
    ...
    /*    PreparedStatement ps;
        ...
        try {
            ...
            if(rs.next()){
*/
                Dash_coach ds= new Dash_coach();
                ds.setVisible(true);
                ds.pack();
                ds.setLocationRelativeTo(null);
                ds.setExtendedState(JFrame.MAXIMIZED_BOTH);
                //ds.jLabel2.setText("Welcome "+use+" ");
...
/*
            ...
            Logger.getLogger(login_Coach.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  */
    ...
    private void jLabelRegisterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelRegisterMouseClicked
        Register_Coach fg  =  new Register_Coach ();
        fg.setVisible(true);
       fg.setLocationRelativeTo(null);
        fg.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_Coach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new login_Coach().setVisible(true);
            }
        });
    }
